      ...
      <div className="w-1/2 h-full bg-black flex flex-col items-center justify-center">
        <div className="text-center">
          <h2 className="text-4xl text-white font-semibold">Sign In</h2>
           ...
           <button className="mt-6 wbg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-3 rounded-full text-lg shadow-lg focus:outline-none ring-2 ring-blue-500 ring-opacity-50 hover:shadow-xl transition duration-300">
            Sign In with Wallet
          </button>
