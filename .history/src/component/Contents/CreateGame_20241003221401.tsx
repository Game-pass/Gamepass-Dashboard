    ...
    <div className="p-6 relative"> {/* Add relative to the container */}
      ...
      {isSdkModalOpen && (
        <Modal onClose={handleCloseSdkModal}>
          <h2 className="text-black" style={{fontSize: "20px"}}>Install GamePass SDK</h2> {/* H2 text is black */}
          <p className="text-black" style={{fontSize: "20px"}}>Run the following command to install the SDK:</p> {/* P text is black */}
