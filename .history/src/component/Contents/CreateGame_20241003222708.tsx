      ...
      {isCongratsPopupOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center" onClick={() => setIsCongratsPopupOpen(false)}>
          <div className="bg-white p-8 rounded-lg">
            <h2 className="text-black">Congratulations!</h2>
            <p className="text-black">You have successfully created your game.</p> 
            <Button onClick={handleCloseSdkModal} className="bg-darkBlue hover:bg-gray-800 ml-100">
                Ok Got It 
            </Button>
          </div>
        </div>
