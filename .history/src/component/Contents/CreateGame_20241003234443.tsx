...
const CreateGame: React.FC = () => {
  ...
  const handleCreateGame = () => {
    ...
    setGames([createdGame, ...games]); // Add the new game to the beginning of the list
  ...
  return (
    <div className="p-6 relative min-h-screen flex flex-col items-center"> {/* Center the content */}
      {/* Show success alert */}
      {showSuccessAlert && (
      ...
      {/* Create Game Button - Positioned lower with margin */}
