...
const CreateGame: React.FC = () => {
  ...
  return (
    <div className="p-6 relative min-h-screen flex flex-col items-center justify-start"> {/* Align content at the top */}
      {/* Show success alert */}
      {showSuccessAlert && (
      ...
      {games.length === 0 ? (
        ...
        <>
          ...
          />
          {/* Create Game Button - Positioned at the top right of the table */}
          <Button className="absolute top-16 right-4" onClick={() => setIsCreateGameModalOpen(true)}>
            Create Game
          </Button>
        </>
      )}
