...
const CreateGame: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <Button className="absolute right-4 text-xs" onClick={() => setIsCreateGameModalOpen(true)}>
        Create Game
      </Button>
      ...
      {isCreateGameModalOpen && (
        <Modal onClose={() => setIsCreateGameModalOpen(false)}>
          <h2 className='text-black' style={{fontSize: "20px", justifyContent: "center", alignItems: center}}>Create a New Game</h2>
          <Input
            label="Game Name"
            value={newGame.name}
