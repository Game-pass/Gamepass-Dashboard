      ...
      <tbody>
        {games.map((game, index) => (
          <tr key={index} className="hover:bg-gray-50">
            <td className="px-4 py-2 border border-[gray-300]">{game.name}</td>
            <td className="px-4 py-2 border border-[gray-300]">{game.description}</td>
            <td className="px-4 py-2 border border-[gray-300]">{game.gameType}</td>
            <td className="px-4 py-2 border border-[gray-300]">{game.createdAt.toLocaleString()}</td>
